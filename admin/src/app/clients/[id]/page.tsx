        ...
        <div className="px-6 pb-6">
           <div className="flex flex-col md:flex-row md:items-end gap-4 -mt-10 relative z-10">
              <div className="relative size-24 shrink-0">
                 <img src={client.photo_url || `https://i.pravatar.cc/150?u=${client.id}`} alt={client.name} className="size-full object-cover rounded-[24px] border-4 border-white shadow-lg shadow-black/5" />
