          ...
          <div className="flex flex-col items-center justify-center mt-24 px-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="relative mb-8">
              <div className="h-24 w-24 bg-white rounded-[2rem] flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-slate-100/50 -rotate-12">
                <Building2 className="h-10 w-10 text-slate-200" strokeWidth={1.5} />
              </div>
            ...
            <h3 className="text-[20px] font-black text-slate-900 mb-2 tracking-tight">Поездок пока нет</h3>
            <p className="text-[14px] text-slate-500 font-medium leading-relaxed mb-8">Вы еще ничего не забронировали. Самое время найти идеальные апартаменты для следующей поездки.</p>
