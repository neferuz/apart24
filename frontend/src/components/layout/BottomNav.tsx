...
export function BottomNav() {
  ...
  const tabs = [
    ...
    { icon: HeartIcon, id: "/wishlist", label: "Вишлист", badge: likedCount }, 
            ...
            >
              ...
              <div className="relative">
                ...
                {tab.badge !== undefined && tab.badge > 0 && (
                  <span className="absolute -top-1.5 -right-2 h-4 min-w-[16px] px-1 bg-[#FF3B30] text-white text-[9px] font-black rounded-full flex items-center justify-center border-2 border-white z-20">
                    {tab.badge}
                  </span>
                )}
              </div>
