  ...
  return (
    <div className="flex items-center justify-between px-5 pt-5 pb-3 bg-white">
      <div className="flex items-center gap-3">
        <div className="relative h-10 w-10 overflow-hidden rounded-full bg-slate-100 flex items-center justify-center border border-slate-50">
          {user?.photo_url ? (
              <Image
                src={user.photo_url}
                alt="Avatar"
              ...
              <span className="text-[16px] font-black text-slate-400">{user.first_name[0]}</span>
          ) : (
              <Image
      ...
      <div className="flex items-center gap-2">
        <Link href="/notifications" className="relative flex h-10 w-10 items-center justify-center rounded-full bg-[#F5F5F7] text-slate-800 active:scale-95 transition-transform">
